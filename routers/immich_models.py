...
#   filename: From URL
#   timestamp: 2026-01-27T00:22:41+00:00
#   immich-tag: v2.4.1
...
class LibraryResponseDto(BaseModel):
    ...
    name: str
    ownerId: str
    refreshedAt: Annotated[Optional[AwareDatetime], Field(...)] = None
    updatedAt: AwareDatetime
...
class MapMarkerResponseDto(BaseModel):
    ...
    country: Annotated[Optional[str], Field(...)] = None
    id: str
    lat: float
    lon: float
    state: Annotated[Optional[str], Field(...)] = None
...
class MemoriesUpdate(BaseModel):
    duration: Annotated[Optional[int], Field(ge=1)] = None
    enabled: Optional[bool] = None
...
class OcrConfig(BaseModel):
    enabled: bool
    maxResolution: Annotated[int, Field(ge=1)]
    minDetectionScore: Annotated[float, Field(ge=0.1, le=1.0)]
    minRecognitionScore: Annotated[float, Field(ge=0.1, le=1.0)]
    modelName: str
...
class PersonResponseDto(BaseModel):
    birthDate: Annotated[Optional[date], Field(...)] = None
    color: Optional[str] = None
    id: str
    isFavorite: Optional[bool] = None
    isHidden: bool
...
class PluginFilterResponseDto(BaseModel):
    ...
    methodName: str
    pluginId: str
    schema_: Annotated[Optional[Dict[str, Any]], Field(alias="schema")]
    supportedContexts: List[PluginContext]
    title: str
...
class ReverseGeocodingStateResponseDto(BaseModel):
    lastImportFileName: Annotated[Optional[str], Field(...)] = None
    lastUpdate: Annotated[Optional[str], Field(...)] = None
...
class SessionCreateResponseDto(BaseModel):
    appVersion: Annotated[Optional[str], Field(...)] = None
    createdAt: str
    current: bool
    deviceOS: str
    deviceType: str
...
class SyncAlbumV1(BaseModel):
    ...
    order: AssetOrder
    ownerId: str
    thumbnailAssetId: Annotated[Optional[str], Field(...)] = None
    updatedAt: AwareDatetime
...
class SyncAssetExifV1(BaseModel):
    ...
    city: Annotated[Optional[str], Field(...)] = None
    country: Annotated[Optional[str], Field(...)] = None
    dateTimeOriginal: Annotated[Optional[AwareDatetime], Field(...)] = None
    description: Annotated[Optional[str], Field(...)] = None
    exifImageHeight: Annotated[Optional[int], Field(...)] = None
    exifImageWidth: Annotated[Optional[int], Field(...)] = None
    exposureTime: Annotated[Optional[str], Field(...)] = None
    fNumber: Annotated[Optional[float], Field(...)] = None
    fileSizeInByte: Annotated[Optional[int], Field(...)] = None
    focalLength: Annotated[Optional[float], Field(...)] = None
    fps: Annotated[Optional[float], Field(...)] = None
    iso: Annotated[Optional[int], Field(...)] = None
    latitude: Annotated[Optional[float], Field(...)] = None
    lensModel: Annotated[Optional[str], Field(...)] = None
    longitude: Annotated[Optional[float], Field(...)] = None
    make: Annotated[Optional[str], Field(...)] = None
    model: Annotated[Optional[str], Field(...)] = None
    modifyDate: Annotated[Optional[AwareDatetime], Field(...)] = None
    orientation: Annotated[Optional[str], Field(...)] = None
    profileDescription: Annotated[Optional[str], Field(...)] = None
    projectionType: Annotated[Optional[str], Field(...)] = None
    rating: Annotated[Optional[int], Field(...)] = None
    state: Annotated[Optional[str], Field(...)] = None
    timeZone: Annotated[Optional[str], Field(...)] = None
...
class SyncAssetFaceV1(BaseModel):
    ...
    imageHeight: int
    imageWidth: int
    personId: Annotated[Optional[str], Field(...)] = None
    sourceType: str
...
class SyncAssetV1(BaseModel):
    checksum: str
    deletedAt: Annotated[Optional[AwareDatetime], Field(...)] = None
    duration: Annotated[Optional[str], Field(...)] = None
    fileCreatedAt: Annotated[Optional[AwareDatetime], Field(...)] = None
    fileModifiedAt: Annotated[Optional[AwareDatetime], Field(...)] = None
    id: str
    isFavorite: bool
    libraryId: Annotated[Optional[str], Field(...)] = None
    livePhotoVideoId: Annotated[Optional[str], Field(...)] = None
    localDateTime: Annotated[Optional[AwareDatetime], Field(...)] = None
    originalFileName: str
    ownerId: str
    stackId: Annotated[Optional[str], Field(...)] = None
    thumbhash: Annotated[Optional[str], Field(...)] = None
    type: AssetTypeEnum
...
class SyncMemoryV1(BaseModel):
    ...
    data: Dict[str, Any]
    deletedAt: Annotated[Optional[AwareDatetime], Field(...)] = None
    hideAt: Annotated[Optional[AwareDatetime], Field(...)] = None
    id: str
    isSaved: bool
    memoryAt: AwareDatetime
    ownerId: str
    seenAt: Annotated[Optional[AwareDatetime], Field(...)] = None
    showAt: Annotated[Optional[AwareDatetime], Field(...)] = None
    type: MemoryType
    updatedAt: AwareDatetime
...
class SyncPersonV1(BaseModel):
    birthDate: Annotated[Optional[AwareDatetime], Field(...)] = None
    color: Annotated[Optional[str], Field(...)] = None
    createdAt: AwareDatetime
    faceAssetId: Annotated[Optional[str], Field(...)] = None
    id: str
    isFavorite: bool
    isHidden: bool
    name: str
...
class SystemConfigOAuthDto(BaseModel):
    ...
    clientId: str
    clientSecret: str
    defaultStorageQuota: Annotated[Optional[int], Field(ge=0)] = None
    enabled: bool
    issuerUrl: str
...
class UsageByUserDto(BaseModel):
    photos: int
    quotaSizeInBytes: Annotated[Optional[int], Field(...)] = None
    usage: int
    usagePhotos: int
    usageVideos: int
    userId: str
...
class VersionCheckStateResponseDto(BaseModel):
    checkedAt: Annotated[Optional[str], Field(...)] = None
    releaseVersion: Annotated[Optional[str], Field(...)] = None
...
class WorkflowActionResponseDto(BaseModel):
    actionConfig: Annotated[Optional[Dict[str, Any]], Field(...)]
    id: str
    order: float
    pluginActionId: str
    workflowId: str
...
class WorkflowFilterItemDto(BaseModel):
    filterConfig: Optional[Dict[str, Any]] = None
    pluginFilterId: UUID


class WorkflowFilterResponseDto(BaseModel):
    filterConfig: Annotated[Optional[Dict[str, Any]], Field(...)]
    id: str
    order: float
    pluginFilterId: str
    workflowId: str
...
class ActivityResponseDto(BaseModel):
    assetId: Annotated[Optional[str], Field(...)] = None
    comment: Optional[str] = None
    createdAt: AwareDatetime
    id: str
    type: ReactionType
...
class AlbumUserAddDto(BaseModel):
    role: AlbumUserRole = AlbumUserRole.editor
    userId: UUID
...
class AssetFaceResponseDto(BaseModel):
    ...
    imageHeight: int
    imageWidth: int
    person: Annotated[Optional[PersonResponseDto], Field(...)]
...
class SyncAuthUserV1(BaseModel):
    avatarColor: Annotated[Optional[UserAvatarColor], Field(...)]
    deletedAt: Annotated[Optional[AwareDatetime], Field(...)] = None
    email: str
    ...
    name: str
    oauthId: str
    pinCode: Annotated[Optional[str], Field(...)] = None
    profileChangedAt: AwareDatetime
    quotaSizeInBytes: Annotated[Optional[int], Field(...)] = None
    quotaUsageInBytes: int
    storageLabel: Annotated[Optional[str], Field(...)] = None
...
class UserAdminResponseDto(BaseModel):
    ...
    id: str
    isAdmin: bool
    license: Annotated[Optional[UserLicense], Field(...)]
    name: str
    oauthId: str
    profileChangedAt: AwareDatetime
    profileImagePath: str
    quotaSizeInBytes: Annotated[Optional[int], Field(...)] = None
    quotaUsageInBytes: Annotated[Optional[int], Field(...)] = None
    shouldChangePassword: bool
    status: UserStatus
    storageLabel: Annotated[Optional[str], Field(...)] = None
    updatedAt: AwareDatetime
...
class SearchAssetResponseDto(BaseModel):
    ...
    nextPage: Annotated[Optional[str], Field(...)] = None
    total: int
...
class AlbumResponseDto(BaseModel):
    albumName: str
    albumThumbnailAssetId: Annotated[Optional[str], Field(...)] = None
    albumUsers: List[AlbumUserResponseDto]
    assetCount: int
    assets: List[AssetResponseDto]
    contributorCounts: Optional[List[ContributorCountResponseDto]] = None
    createdAt: AwareDatetime
    description: str
...
class SharedLinkResponseDto(BaseModel):
    ...
    createdAt: AwareDatetime
    description: Annotated[Optional[str], Field(...)] = None
    expiresAt: Annotated[Optional[AwareDatetime], Field(...)] = None
    id: str
    key: str
    password: Annotated[Optional[str], Field(...)] = None
    showMetadata: bool
    slug: Annotated[Optional[str], Field(...)] = None
    token: Optional[str] = None
    type: SharedLinkType
    userId: str
